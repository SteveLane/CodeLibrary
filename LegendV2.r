...
## Author: Steve Lane
## Date: Tue 10/09/2013
## Synopsis: Adapts the legend code to produce filled boxes
## http://stackoverflow.com/questions/5520637/legend-in-base-r-can-fill-refrain-from-drawing-boxes-on-some-lines-can-fill-dr
################################################################################
################################################################################
